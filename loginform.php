		...
		<div id="wrapper">
			...
			<section class="panel color0">
				...
				<div class="span-1-25">
					...
					<div class="span-1-75">
						<form method="post" action="input.php" style="font-family:'Questrial',sans-serif;font-weight:100;">

						    <div class="field">
								<h2 class="major" style="font-family:'Questrial',sans-serif;font-weight:100;">Login</h1>
							</div>
            ...
            <div id="wrapper">
			<section class="panel color0" id="first">
			    <div class="inner columns divided">
			       <div class="span-2-25">
			          <form method="post" action="input.php" style="font-family:'Questrial',sans-serif;font-weight:100;">
				    ...
				    <div class="field">
					    ...
					    <input type="password" name="pass" id="pass" placeholder="Password" required/>
							...
							<ul class="actions">
								<li><input type="submit" name="submit" value="Login" class="button special" /></li>
